...
const PROD_RANGES: Dictionary = {
	...
	TileType.DARK_BASE:        {"gold": [5, 8], "food": [2, 3], "iron": [2, 4], "pop": [2, 4]},
	TileType.MINE_TILE:        {"gold": [1, 2], "food": [0, 1], "iron": [4, 7], "pop": [1, 2]},
	TileType.FARM_TILE:        {"gold": [1, 2], "food": [5, 8], "iron": [0, 1], "pop": [2, 3]},
	TileType.WILDERNESS:       {"gold": [0, 1], "food": [0, 2], "iron": [0, 1], "pop": [0, 1]},
	TileType.EVENT_TILE:       {"gold": [6, 10], "food": [2, 4], "iron": [0, 2], "pop": [1, 2]},
	TileType.START:            {"gold": [5, 8], "food": [2, 3], "iron": [1, 3], "pop": [2, 3]},
	TileType.RESOURCE_STATION: {"gold": [0, 0], "food": [0, 0], "iron": [0, 0], "pop": [0, 1]},
	TileType.CORE_FORTRESS:    {"gold": [15, 18], "food": [3, 5], "iron": [5, 7], "pop": [4, 6]},
	TileType.NEUTRAL_BASE:     {"gold": [5, 8], "food": [2, 3], "iron": [2, 3], "pop": [1, 3]},
	TileType.TRADING_POST:     {"gold": [8, 12], "food": [2, 3], "iron": [1, 2], "pop": [1, 2]},
	TileType.WATCHTOWER:       {"gold": [2, 3], "food": [1, 2], "iron": [1, 2], "pop": [1, 1]},
	TileType.RUINS:            {"gold": [3, 5], "food": [0, 1], "iron": [0, 2], "pop": [1, 1]},
	TileType.HARBOR:           {"gold": [6, 9], "food": [4, 7], "iron": [0, 1], "pop": [2, 3]},
	TileType.CHOKEPOINT:       {"gold": [2, 4], "food": [1, 2], "iron": [2, 5], "pop": [1, 2]},
}
