...
const HERO_PORTRAITS: Dictionary = {
	"rin": "res://assets/characters/designs/01_rin_A.webp",
	"yukino": "res://assets/characters/designs/02_yukino_A.webp",
	"momiji": "res://assets/characters/designs/03_momiji_C.webp",
	"hyouka": "res://assets/characters/designs/04_hyouka_B.webp",
	"suirei": "res://assets/characters/designs/05_suirei_B.webp",
	"gekka": "res://assets/characters/designs/06_gekka_A.webp",
	"hakagure": "res://assets/characters/designs/07_hakagure_B.webp",
	"sou": "res://assets/characters/designs/08_sou_C.webp",
	"shion": "res://assets/characters/designs/09_shion_A.webp",
	"homura": "res://assets/characters/designs/10_homura_A.webp",
	"shion_pirate": "res://assets/characters/designs/11_shion_pirate_D.webp",
	"youya": "res://assets/characters/designs/12_youya_C.webp",
	"hibiki": "res://assets/characters/designs/13_hibiki_A.webp",
	"sara": "res://assets/characters/designs/14_sara_C.webp",
	"mei": "res://assets/characters/designs/15_mei_C.webp",
	"kaede": "res://assets/characters/designs/16_kaede_B.webp",
	"akane": "res://assets/characters/designs/17_akane_B.webp",
	"hanabi": "res://assets/characters/designs/18_hanabi_D.webp",
}
...
## Pirate: High gold, low food/iron — rich mercenaries but logistics are expensive
## Dark Elf: Balanced base + slaves — slave economy supplements weak baseline
...
const FACTION_PARAMS: Dictionary = {
	FactionID.ORC: {
		"food_per_soldier": 0.4,           # v4.6: 0.5→0.4 — orcs are cheap to feed (horde identity)
		"recruit_cost_gold": 45,           # v4.6: 60→45 — orcs recruit cheaply (quantity over quality)
	...
	FactionID.PIRATE: {
		...
		"recruit_cost_gold": 75,           # v4.6: 60→75 — mercenaries are expensive
		"recruit_cost_iron": 4,            # v4.6: 5→4 — pirates salvage weapons
		"slave_capture_bonus": 1.0,
		"base_production_mult": 0.7,       # v3.0.1: 0.6→0.7 (前期产出提升)
		"gold_income_mult": 1.4,           # v4.6: 1.3→1.4 — pirate plunder identity
		"iron_income_mult": 0.6,           # v4.6: 0.65→0.6 — pirates don't mine
		"food_production_mult": 0.7,       # v4.6: 0.75→0.7 — pirates import food
		# 黑市
		"slave_sell_price": 25,
		"slave_buy_price": 40,
		# 掠夺
	...
	FactionID.DARK_ELF: {
		...
		"base_production_mult": 0.75,      # v4.6: 0.7→0.75 — slightly better base
		"gold_income_mult": 1.0,           # v4.6: 0.9→1.0 — balanced gold
		"iron_income_mult": 0.8,           # v4.6: 1.0→0.8 — elves use magic, not iron
		"food_production_mult": 0.8,       # v4.6: consistent low food (slaves compensate)
